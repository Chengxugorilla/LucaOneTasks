...
try:
    ...
    from .ppi.models.LucaPPI3 import LucaPPI3
    from .ppi.models.LucaPPI4 import LucaPPI4
    ...
    from src.ppi.models.LucaPPI3 import LucaPPI3
    from src.ppi.models.LucaPPI4 import LucaPPI4
...
def get_args():
    ...
    parser.add_argument("--best_metric_type", type=str, default="f1",
                        choices=[
                            "loss", "acc", "jaccard", "prec", "recall", "f1", "fmax", "roc_auc",
                            "pr_auc", "mcc", "sp_statistic", "mse", "mae", "r2", "ps_statistic"
                        ],
    ...
    parser.add_argument("--llm_type", default=None, type=str,
                        choices=["none", "onehot", "esm", "lucaone_gplm", "luca_separated", "dnabert", "dnaberts", "dnabert-esm", "lucaone_gplm-unimol"],
    ...
    parser.add_argument("--loss_reduction", default="mean",
                        choices=["none", "meansum", "mean", "meanmean"], type=str,
                        help="loss reduction")
...
def get_model(args):
    ...
    elif args.model_type in ["lucappi3"]:
        model_class = LucaPPI3
    ...
    elif args.model_type in ["lucappi4"]:
        model_class = LucaPPI4
        model_config.decoder_layers = args.num_hidden_layers
        model_config.decoder_attention_heads = args.num_attention_heads
        model_config.decoder_ffn_dim = args.intermediate_size
        model_config.embedding_input_size_a = args.embedding_input_size_a if args.embedding_input_size_a else args.embedding_input_size
